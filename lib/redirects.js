...
const redirectPages = [
  {
    source: '/for/architects',
    destination: '/for/saas-platforms',
    permanent: true,
  },
  {
    source: '/for/CISOs',
  ...
  {
    source: '/for/influxdb',
    destination: '/for/private-connectivity',
    permanent: true,
  },
  {
    source: '/for/kafka-financial-services',
    destination: '/for/kafka',
    permanent: true,
  },
  {
    source: '/for/saas-connectivity',
    destination: '/for/saas-platforms',
    permanent: true,
  },
  {
    source: '/for/sales-engineers',
    destination: '/for/saas-platforms',
    permanent: true,
  },
];

module.exports = { redirectDocs, redirectJobs, redirectPages };
