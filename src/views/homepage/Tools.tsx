...
const TEXTS = [
  [
    'To be private and secure by-design, applications must have granular control over every trust and access decision. This requires a variety of complex cryptographic and messaging protocols to work together – securely and at scale.',
    'Application developers have to think about issuing unique cryptographic keys and credentials to all application entities. Design ways to safely store secrets in hardware. Securely distribute roots of trust. Safely rotate and revoke keys and credentials. Setup channels that gaurantee data integrity and authenticty. Control and enforce authorization decisions etc.',
  ],
  [
    ...
    'We have taken proven cryptographic protocols and made them easy to use on the command line or as a programming library. We handle all the underlying complexity and give your application high level, composable building blocks to create end-to-end, application layer trust.',
