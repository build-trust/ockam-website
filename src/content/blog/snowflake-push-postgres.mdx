...
category: Learning
date: '2024-09-20'
description: Setup a private point-to-point data stream between Snowflake and PostgreSQL.
...
The Snowflake Push to PostgreSQL Connector by Ockam is [invite only](mailto:hello@ockam.io?subject=Invite%20for%20Push%20to%20PostgreSQL%20Connector),
