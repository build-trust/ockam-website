...
In fact, this post itself was signed with a public key! It’s part of Ockam’s process that allows anyone to make contributions to the [open-source website](https://github.com/build-trust/ockam-website).
