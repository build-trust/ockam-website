...
and clouds. We are able to hides all the underlying complexity and footguns behind
...
If you've been part of a project that was rewritten in Rust? Come share your team's story
with us on our [discord server](https://discord.gg/bewvnm6zqS).

We're also hiring for both Rust and Elixir roles, come [join our passionate team of builders](https://www.ockam.io/team).
