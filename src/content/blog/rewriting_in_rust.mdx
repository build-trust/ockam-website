...
This meant that Ockam's actor implementation, which we later called Ockam [Workers](https://docs.ockam.io/reference/libraries/rust/nodes),
...
This sealed the deal and I was convinced we should re-write Ockam in Rust. 
