...
| L5 | Senior Engineer I | Engineering [Team] Lead | - |
| L6 | Staff Engineer I | Head of [Area] | - |
| L7 | Staff Engineer II | Director of [Product] | - |
| L8 | Principal Engineer | Sr Director | - |
...
* Responsibility
  * Completes Tasks assigned to them by The Team manager and acts as an on-call first responder for their Teammates.
...
* Reliability
  ...
  * Given an introduction to a small Task  from The Team manager can drive that Task to completion by incorporating feedback and suggestions from Senior Engineers.
...
### Impact
* Scope
  * Develops, ships, and maintains product features with guidance from The Team manager, and senior engineers.
* Responsibility
...
* Collaboration / Communication
  ...
  * Has continuous communication with, and knows when to push appropriate information to, the Team Manager.
  * Effectively manages a 1:1 agenda with their manager.
* Living Values
  * Is trusted by The Team inside the scope of their responsibility.
...
* Scope
  ...
  * Acts as a multiplier on The Team. Often prioritizes, and values, unowned or undesirable tasks that enables others on Team to move faster.
* Responsibility
...
* Collaboration / Communication
  * Works with across their Team, and adjacent Teams (e.g., DevEx) to solve problems and drive projects to completion.
...
### Functional Skills
* Technical Capabilities
  * Ensures technical designs are properly evaluated for projects under RACI and advises Team on how to improve execution.
...
* Engineering Strategy
  * Works with The Team Manager to break down complex OKRs into easy-to-understand projects that can be effectively built and maintained by IC L1 to L5s.
