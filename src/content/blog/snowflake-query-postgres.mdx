...
The Snowflake Query Remote PostgreSQL Connector by Ockam is [invite only](mailto:hello@ockam.io?subject=Invite%20for%20Query%20Remote%20PostgreSQL%20Connector),
to get an invite please drop us an email at [hello@ockam.io](mailto:hello@ockam.io?subject=Invite%20for%20Query%20Remote%20PostgreSQL%20Connector).
