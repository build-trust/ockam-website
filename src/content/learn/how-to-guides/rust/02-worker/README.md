...
Now that we've [created our first node](/learn/how-to-guides/rust/01-node#readme), let's create a new
...
[hello_ockam](/learn/how-to-guides/rust/#setup) project. We're creating this inside the `src`
