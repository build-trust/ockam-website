...
What we do is who we are. We bring this philosophy to our engineer roles. Because we are a small and growing team we spend most of their time _completing tasks_ regardless of our level. A `Level 7 Architect` is responsible for _exploring their space_, _defining a set of problems_, then _picking a solution_, before _building / shipping the tasks_.
